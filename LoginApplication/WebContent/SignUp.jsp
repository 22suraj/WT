...
<%
java.util.Date now = new java.util.Date(); String DATE_FORMAT1 = "dd/MM/yyyy";
...
<tr>
<td> <strong><em><font color="#990000" size="+1" face="Times New Roman" style="text-decoration:underline">User Registration</font></em></strong> </td>
</tr>
</table>
<table border="black" align ="center">
<tr>
<td><form name="s" action="/register" method="get" onSubmit="return valid()">
